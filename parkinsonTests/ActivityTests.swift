...
class ActivityTests {
    ...
    func test(){
        ...
        let frequencies = [eventTest, eventLundi, eventSamedi, eventMercredi]
        ...
        XCTAssert(Calendar.current.component(.weekday, from: activity.dateNextPractice()) == 2, "Next practice is not on satursday") // Depends on the current date
    }
